...
export default function CarsPage() {
  ...
  const activeFilters = useMemo(() => {
    ...
    if (filters.mileageRange) {
      const opt = ['0-5000', '5000-15000', '15000-30000', '30000+'].find(
        (o) => o === filters.mileageRange,
      );
      const label = ['0-5000 كم', '5-15 ألف كم', '15-30 ألف كم', '+30 ألف كم'].find(
        (_, i) => ['0-5000', '5000-15000', '15000-30000', '30000+'][i] === opt,
      );
